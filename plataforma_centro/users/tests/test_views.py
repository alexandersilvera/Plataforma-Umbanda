...
from plataforma_centro.users.models import User
from plataforma_centro.users.tests.factories import UserFactory
from plataforma_centro.users.views import (
    UserRedirectView,
    UserUpdateView,
    user_detail_view,
)
